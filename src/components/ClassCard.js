...
const ClassCard = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <div className="sm:px-5 px-2 sm:py-10 py-5 sm:mt-0 mt-3">
        <h3 className="font-poppins font-bold text-2xl">{data.title}</h3>
        <div className="sm:mt-8 mt-4 flex gap-10">
        ...
        <div className="sm:my-5 my-3 sm:pb-3 pb-0 cursor-pointer group relative">
