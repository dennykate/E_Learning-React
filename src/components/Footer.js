        ...
        <div className="">
          ...
          <div className="grid grid-cols-2 ">
            <div className="flex flex-col gap-3">
              <h6 className=" text-white sm:text-lg text-xs">- Home</h6>
              <h6 className=" text-white sm:text-lg text-xs">- Teachers</h6>
              <h6 className=" text-white sm:text-lg text-xs">- Contact Us</h6>
            </div>
            <div className="flex flex-col gap-3">
              <h6 className=" text-white sm:text-lg text-xs">- About</h6>
              <h6 className=" text-white sm:text-lg text-xs">- Error</h6>
            </div>
          </div>
        </div>
